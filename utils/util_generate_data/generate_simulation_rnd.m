function [tvec, simulated_signal, Fs, data, btime_f1, burst_f1, cyc1] = generate_simulation_rnd(method, T, f1, f2, nBurst1, nBurst2, SNR_wn, rng_pks, rnd_seed, verbose)
    %% Function: 'generate_simulation_rnd'
    % DESCRIPTION
