...
%   * (5)     for Figure 6A-C
%   * (1)-(4) for Figures 6-1, 6-2, 6-3
% `AUC*.mat` can be acquired by running `fig5C_compute_ecdf.m`.
...
band_name = 'theta';
auc = load(['../Figure5/AUC_stage2_' band_name '.mat']).AUC.(metric);
...
yticks(linspace(vmin,vmax+2.6,5));
